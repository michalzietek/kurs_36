...
import requests
from file_handler import CountriesSelector
...
"""
country_data = file_handler.lookup_for_country_in_data(user_country)
if country_data:
-------------------
if country_data := file_handler.lookup_for_country_in_data(country_data):
"""
